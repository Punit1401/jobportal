...
// import { Eye, EyeOff } from "lucide-react"; // આઈકોન્સ માટે
...
//       {/* Left Side: Image Section (Nucleus Style) */}
...
//               Build your career effortlessly with our powerful platform.
//             </p>
//           </div>
...
//                 className="w-full px-5 py-4 rounded-2xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 transition-all outline-none font-medium placeholder:text-slate-400"
//               />
//             </div>
...
//               <label htmlFor="remember" className="text-sm text-slate-600 font-medium cursor-pointer">Remember sign in details</label>
//             </div>
...
//           {/* <button 
//             type="button"
//             className="w-full flex items-center justify-center gap-3 border border-slate-200 py-4 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 transition-all mb-8"
//           >
