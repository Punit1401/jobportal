                    ...
                    <div className="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden relative">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    {loading ? (
                                        <tr><td colSpan="6" className="px-8 py-20 text-center text-slate-400 font-bold animate-pulse">Loading contacts...</td></tr>
                                            ...
                                            <td className="px-8 py-6 border-b border-slate-50">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-slate-500 font-bold">Customer</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6 border-b border-slate-50">
                                        ...
                                        <tr>
                                            <td colSpan="6" className="px-8 py-20 text-center text-slate-400 font-bold">No contacts found in your inquiry history.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
                        ...
                        <div className="p-8 flex items-center justify-between bg-slate-50/30">
                            <p className="text-sm font-bold text-slate-400">Showing {contacts.length} contacts</p>
                            <div className="flex gap-2">
                                <button className="p-3 rounded-xl bg-white border border-slate-100 text-slate-400"><ChevronLeft size={20} /></button>
                                <button className="w-10 h-10 rounded-xl bg-indigo-600 text-white font-bold text-sm">1</button>
                                <button className="p-3 rounded-xl bg-white border border-slate-100 text-slate-400"><ChevronRight size={20} /></button>
                            </div>
                        </div>
                    </div>
