...
import { 
  ...
  ShoppingBag, Sparkles, Megaphone, HelpCircle, Layout, MessageSquare
} from 'lucide-react';
...
export default function Sidebar({ activePage }) {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="lg:hidden flex items-center justify-between p-4 bg-white border-b border-slate-100 sticky top-0 z-50 h-16">
        <Link href="/serviceprovider/dashboard" className="text-xl font-black text-indigo-600">
